...
public class InstagramPublisher {
    ...
    private static final String[] textLegend = {
            ...
            "Inovação e Criatividade em Cada Linha de Código. Saiba Mais em " + hiperlink,
            "Seu Futuro Digital Começa Aqui. Explore Nossas Soluções em " + hiperlink,
            "Desenvolvendo o Amanhã, Hoje. Conheça Nossos Serviços em " + hiperlink
    };
